...
let cardImage3 =
  "https://images.unsplash.com/photo-1453749024858-4bca89bd9edc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1007&q=80";
    ...
    <div className="Groups">
      ...
      <div className="Groups__list">
        ...
        <div className="Groups__card--3">
          <GroupCard name="Virtual Bookclub" members="106" location="Online" picture={cardImage2} />
        </div>
        <div className="Groups__card--4">
          <Link className="Groups__list__link" to={props.to}>
            {props.moreGroups}
          </Link>
        </div>
      </div>
