...
storiesOf("Banner", module)
  ...
  .add("Home Banner with Welcome text", () =>
    <Banner background={Banner__purpleBig} Height='380px' FontSize='80px' LineHeight='120px' display='flex' flexdirection='column'
    justifycontent='center' alignitems='center'>
        <h2>Welcome, Justine</h2>
    </Banner>
  )
  .add("Home Banner with Welcome Back text", () =>
    <Banner background={Banner__purpleBig} Height='380px' FontSize='80px' LineHeight='120px' TextAlign="left" display='flex' flexdirection='column'
    justifycontent='center' alignitems='center'> 
  ...
  .add("Profile Banner with Text", () =>
    <Banner background={Banner__pink} display='flex' flexdirection='column'
    justifycontent='center' alignitems='center'>
