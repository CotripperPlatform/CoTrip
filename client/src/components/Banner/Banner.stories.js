...
storiesOf("Banner", module)
  ...
  .add("Home Banner with Welcome Back text", () => (
    <Banner background={Banner__purpleBig}>
      <h2 style={{ textAlign: "left", display: "inline-block" }}>
        Welcome Back,
        <br />
        Justine.
      </h2>
  ...
  .add("Community Banner with input and yellow join button", () => (
    <Banner background={Banner__purpleBig}>
  ...
  .add("Community Banner with input and pink leave button", () => (
    <Banner background={Banner__purpleBig}>
      <h3 style={{ margin: 0 }}>Group: Moms in DC</h3>
      <InputTextField
        type="text"
